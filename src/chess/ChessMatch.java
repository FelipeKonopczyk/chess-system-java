...
public class ChessMatch {
	...
	private void initialSetup() {
		//placeNewPiece('c',5,new Rook(board, Colour.WHITE));
		...
		//board.placePiece(new King(board, Colour.BLACK) ,new Position(7,4));
		//board.placePiece(new King(board, Colour.WHITE) ,new Position(0,4));	
	}
